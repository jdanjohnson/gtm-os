...
class NotificationService:
    ...
    async def on_approval_needed(self, experiment_id: str, details: str) -> list[Notification]:
    ...
    async def on_failure(self, experiment_id: str, error: str, failure_count: int) -> list[Notification]:
        return await self.notify(
    ...
    async def on_learning(self, experiment_id: str, learning: str) -> list[Notification]:
        return await self.notify(
    ...
    async def on_complete(self, experiment_id: str, summary: str) -> list[Notification]:
        return await self.notify(
    ...
    async def on_budget_threshold(self, experiment_id: str, pct_used: float) -> list[Notification]:
        return await self.notify(
    ...
    async def on_rule_created(self, experiment_id: str | None, rule_file: str) -> list[Notification]:
        return await self.notify(
