        ...
        {tab === "setup" && (
          <div className="space-y-6">
            ...
            <div className="space-y-4">
              <div>
                <h3 className="text-sm font-semibold text-gray-500 uppercase tracking-wider mb-1">Platform Keys</h3>
            ...
            <div className="space-y-4 border-t border-black/[0.06] pt-6">
              <div>
                <h3 className="text-sm font-semibold text-gray-500 uppercase tracking-wider mb-1">Research Tool Keys</h3>
                <p className="text-xs text-gray-500">
